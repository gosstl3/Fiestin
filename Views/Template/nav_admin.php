    ...
    <ul class="app-menu">
        ...
        <li>
            <a class="app-menu__item" href="<?= base_url(); ?>clientes">
                <i class="app-menu__icon far fa-address-card" aria-hidden="true"></i>
        ...
        <li>
            <a class="app-menu__item" href="<?= base_url(); ?>proveedor">
                <i class="app-menu__icon fas fa-mug-hot" aria-hidden="true"></i>
        ...
        <li>
            <a class="app-menu__item" href="<?= base_url(); ?>pedidos">
                <i class="app-menu__icon fas fa-wine-bottle" aria-hidden="true"></i>
